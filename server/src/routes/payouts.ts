...
import { getPayoutsHandler, simulateTransferHandler } from '../controllers/payouts';
 ...
 */
router.get('/:circleId', authenticate, getPayoutsHandler);
 ...
 */
router.post('/simulate-transfer', simulateTransferHandler);
