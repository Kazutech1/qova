...
const circles_1 = require("../controllers/circles");
 ...
 */
router.post('/', auth_1.authenticate, circles_1.createCircleHandler);
/**
 * @swagger
 * /circles/join:
 *   post:
 ...
 */
router.post('/join', auth_1.authenticate, circles_1.joinCircleHandler);
/**
 * @swagger
 ...
 *         description: Invalid invite code
 */
router.get('/by-invite/:invite_code', auth_1.authenticate, circles_1.getCircleByInviteHandler);
/**
 * @swagger
 * /circles/{id}:
 *   get:
 ...
 */
router.get('/:id', auth_1.authenticate, circles_1.getCircleHandler);
/**
 * @swagger
 * /circles/{id}/start:
 *   post:
 ...
 */
router.post('/:id/start', auth_1.authenticate, circles_1.startCircleHandler);
/**
 * @swagger
 ...
 */
router.post('/:id/payout-order', auth_1.authenticate, circles_1.setPayoutOrderHandler);
/**
 * @swagger
 * /circles/{id}/members:
 *   get:
 ...
 *         description: Circle not found
 */
router.get('/:id/members', auth_1.authenticate, circles_1.getCircleMembersHandler);
/**
 * @swagger
 * /circles/{id}/history:
 *   get:
 ...
 *         description: Circle not found
 */
router.get('/:id/history', auth_1.authenticate, circles_1.getCircleHistoryHandler);
