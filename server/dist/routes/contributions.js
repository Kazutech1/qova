...
const contributions_1 = require("../controllers/contributions");
 ...
 */
router.post('/pay', auth_1.authenticate, contributions_1.payContributionHandler);
/**
 * @swagger
 ...
 */
router.post('/webhook', contributions_1.webhookHandler);
/**
 * @swagger
 ...
 */
router.post('/simulate-payment', contributions_1.simulatePaymentHandler);
/**
 * @swagger
 ...
 */
router.post('/simulate-all', contributions_1.simulateAllPaymentsHandler);
/**
 * @swagger
 ...
 */
router.get('/:circleId', auth_1.authenticate, contributions_1.getContributionsHandler);
